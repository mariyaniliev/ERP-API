...
router.post('/users', isAdmin_1.isAdmin, user_controller_1.UserController.createUserHandler);
/*
...
router.patch('/users/:id', isAdminOrOwner_1.isAdminOrOwner, user_controller_1.UserController.updateUserHandler);
// * Delete user
